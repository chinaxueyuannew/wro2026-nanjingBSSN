...
| 2 | `control: add vision serial executor and local command watchdog` | `VisionSerialExecutor.ino`、源代码说明、软件架构、测试 / Executor, code guide, architecture and tests | 编译通过；架空故障测试完成 / Build passes; lifted fault test complete |
