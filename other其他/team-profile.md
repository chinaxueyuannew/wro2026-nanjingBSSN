...
| **黄鸣博 / Huang Mingbo** | 照片待补充 / Portrait pending | **电子 / Electronics**：负责供电、Arduino执行控制、电机驱动、舵机、线束和上电安全。 / Responsible for power, Arduino execution control, motor driver, steering servo, wiring and power-on safety. |
